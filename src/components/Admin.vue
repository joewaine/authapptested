                        ...
                        >
                          <template v-for="serve in upserveList">
                            <template v-if="1 === 1">
                              <div
                                class="itemContainer"
                                :class="{ visibleItem: serve.visible }"
                                style="width: 25%;"
                              >
                              ...
                              >{{serve.description}}</div> -->
                                  ...
                                  <div class="row">
                                    <div class="col-6">
                                      <label for="lbs">lbs</label>&nbsp;<span>{{
                                        serve.lbs
                                      }}</span>
                                      <input
                                        id="lbs"
                                        type="number"
                                        v-model="editNumberLbs"
                                        class="lbs-input"
                                        :class="{
                                          visible: editLbs === serve.id,
                                        }"
                                      />
                                      <button
                                        @click="
                                        ...
                                        "
                                        class="submit-lbs-input"
                                        :class="{
                                          visible: editLbs === serve.id,
                                        }"
                                      >
                                        submit {{ editNumberLbs }}
                                      </button>
                                      <button
                                        @click="editLbs = serve.id"
                                        class="edit-lbs-input"
                                        :class="{
                                          invisible: editLbs === serve.id,
                                        }"
                                      >
                                        edit
                                      </button>
                                    ...
                                    <div class="col-6">
                                      <label for="oz">oz</label>&nbsp;<span>{{
                                        serve.oz
                                      }}</span>
                                      <input
                                        id="oz"
                                        type="number"
                                        v-model="editNumberOz"
                                        class="oz-input"
                                        :class="{
                                          visible: editOz === serve.id,
                                        }"
                                      />
                                      <button
                                        @click="
                                      ...
                                      <button
                                        @click="editOz = serve.id"
                                        class="edit-oz-input"
                                        :class="{
                                          invisible: editOz === serve.id,
                                        }"
                                      >
                                        edit
                                      </button>
                                    ...
                                    <div class="col-6">
                                      ...
                                      >&nbsp;<span>{{ serve.height }}</span>
                                      <input
                                        id="height"
                                        type="number"
                                        v-model="editNumberHeight"
                                        class="height-input"
                                        :class="{
                                          visible: editHeight === serve.id,
                                        }"
                                      />
                                      <button
                                        @click="
                                          updateRetailItemHeight(
                                            serve.id,
                                            editNumberHeight
                                          )
                                        "
                                        class="submit-height-input"
                                        :class="{
                                          visible: editHeight === serve.id,
                                        }"
                                      >
                                        submit, {{ editNumberHeight }}
                                      </button>
                                      <button
                                        @click="editHeight = serve.id"
                                        class="edit-height-input"
                                        :class="{
                                          invisible: editHeight === serve.id,
                                        }"
                                      >
                                        edit
                                      </button>
                                    ...
                                    <div class="col-6">
                                      ...
                                      >&nbsp;<span>{{ serve.width }}</span>
                                      <input
                                        id="width"
                                        type="number"
                                        v-model="editNumberWidth"
                                        class="width-input"
                                        :class="{
                                          visible: editWidth === serve.id,
                                        }"
                                      />
                                      <button
                                        @click="
                                          updateRetailItemWidth(
                                            serve.id,
                                            editNumberWidth
                                          )
                                        "
                                        class="submit-width-input"
                                        :class="{
                                          visible: editWidth === serve.id,
                                        }"
                                      >
                                        submit, {{ editNumberWidth }}
                                      </button>
                                      <button
                                        @click="editWidth = serve.id"
                                        class="edit-width-input"
                                        :class="{
                                          invisible: editWidth === serve.id,
                                        }"
                                      >
                                        edit
                                      </button>
                                    ...
                                    <div class="col-6">
                                      ...
                                      >&nbsp;<span>{{ serve.length }}</span>
                                      <input
                                        id="length"
                                        type="number"
                                        v-model="editNumberLength"
                                        class="length-input"
                                        :class="{
                                          visible: editLength === serve.id,
                                        }"
                                      />
                                      <button
                                        @click="
                                          updateRetailItemLength(
                                            serve.id,
                                            editNumberLength
                                          )
                                        "
                                        class="submit-length-input"
                                        :class="{
                                          visible: editLength === serve.id,
                                        }"
                                      >
                                        submit, {{ editNumberLength }}
                                      </button>
                                      <button
                                        @click="editLength = serve.id"
                                        class="edit-length-input"
                                        :class="{
                                          invisible: editLength === serve.id,
                                        }"
                                      >
                                        edit
                                      </button>
                                    ...
                                    <div class="col-6">
                                      ...
                                      >&nbsp;<span>{{ serve.girth }}</span>
                                      <input
                                        id="girth"
                                        type="number"
                                        v-model="editNumberGirth"
                                        class="girth-input"
                                        :class="{
                                          visible: editGirth === serve.id,
                                        }"
                                      />
                                      <button
                                        @click="
                                          updateRetailItemGirth(
                                            serve.id,
                                            editNumberGirth
                                          )
                                        "
                                        class="submit-girth-input"
                                        :class="{
                                          visible: editGirth === serve.id,
                                        }"
                                      >
                                        submit, {{ editNumberGirth }}
                                      </button>
                                      <button
                                        @click="editGirth = serve.id"
                                        class="edit-girth-input"
                                        :class="{
                                          invisible: editGirth === serve.id,
                                        }"
                                      >
                                        edit
                                      </button>
                                  ...
                                  <template v-if="serve.shippable">
                                    <button
                                      @click="shippableEdit(serve.id, false)"
                                    >
                                      make not shippable
                                    </button>
                                  </template>
                                  <template v-else>
                                    <button
                                      @click="shippableEdit(serve.id, true)"
                                    >
                                      make shippable
                                    </button>
                                  </template>
...
{{serve.length}}-->
                                  <template
                                    v-if="
                                      serve.lbs !== undefined &&
                                        serve.oz !== undefined &&
                                        serve.height !== undefined &&
                                        serve.width !== undefined &&
                                        serve.length !== undefined
                                    "
                                  >
                                    visible? {{ serve.visible }}<br />
                                    <template v-if="serve.visible">
                                      <button
                                        @click="visibleEdit(serve.id, false)"
                                      >
                                        make not visible
                                      </button>
                                    </template>
                                    <template v-else>
                                      <button
                                        @click="visibleEdit(serve.id, true)"
                                      >
                                        make visible
                                      </button>
                                    </template>
                                  ...
                                  <template v-else>
                                    <div class="small-message">
                                      please enter item dimensions and weight
                                    </div>
                                    <br />
                                  </template>

                                  <button @click="deleteItem(serve.id)">
                                    delete item
                                  </button>
                                </div>
                              </div>
...
export default {
  ...
  computed: {
    ...
    orderTotal() {
      ...
      return (
        Number(this.total) +
        Number(this.currentTax) +
        Number(this.tip) +
        Number(this.currentAmountToAdd) +
        shippingAmountToAdd
      );
    },
    googleAddress() {
  ...
  watch: {
    currentOrder: {
      handler(val) {
        ...
        if (
          ...
          this.validPostal(this.currentOrder.billing.billing_postal_code)
        ) {
          this.shippingPrice(
            "98122",
            String(this.currentOrder.billing.billing_postal_code),
            String(this.totalWeight / 100),
            "0"
          );
        }
      },
    ...
    total: function(newTotal, oldTotal) {
      ...
      this.currentOrder.charges.preTotal =
        this.orderTotal - this.currentTax - this.tip;
      this.currentOrder.payments.payments[0].amount = this.orderTotal;
  ...
  methods: {
    ...
    async deleteItem(serveid) {
      ...
      console.log(payload);
      this.$http
        .post("/product/deleteitem", payload)
        .then((response) => {
    ...
    async visibleEdit(servid, e) {
      ...
      console.log(payload);
      this.$http
        .post("/product/visibleedit", payload)
        .then((response) => {
          console.log(response);
          this.upservesMongo();
          this.forceRerender();
    ...
    async shippableEdit(servid, e) {
      ...
      this.$http
        .post("/product/shippableedit", payload)
        .then((response) => {
          console.log(response);
          this.upservesMongo();
          this.forceRerender();
    ...
    async updateRetailItemLbs(servid, editNumber) {
      ...
      this.$http
        .post("/product/retaillbs", payload)
        .then((response) => {
          console.log(response);
    ...
    async updateRetailItemHeight(servid, editNumber) {
      ...
      this.$http
        .post("/product/retailheight", payload)
        .then((response) => {
          console.log(response);
    ...
    async updateRetailItemWidth(servid, editNumber) {
      ...
      this.$http
        .post("/product/retailwidth", payload)
        .then((response) => {
          console.log(response);
    ...
    async updateRetailItemLength(servid, editNumber) {
      ...
      this.$http
        .post("/product/retaillength", payload)
        .then((response) => {
          console.log(response);
    ...
    async updateRetailItemGirth(servid, editNumber) {
      ...
      this.$http
        .post("/product/retailgirth", payload)
        .then((response) => {
          console.log(response);
    ...
    async shippingPrice(orig, dest, lb, oz) {
      ...
      let responseAcf = await this.$http.get(`/shippingcalculation`, {
        params: {
          ZipOrigination: orig,
          ZipDestination: dest,
          Pounds: lb,
    ...
    currentlyavailable(startTime, endTime, rules, futureDay, futureTime) {
      ...
      if (futureDay) {
        if (!futureTime) {
          if (
            rules.includes(futureDay.dayLabel.substring(0, 3).toLowerCase())
          ) {
            return true;
          }
        } else {
            ...
            self.$http
              ...
              .then(function(response) {
                ...
                if (self.$store.state.storeCurrentOrder.preorder === true) {
                  self.scheduleAnOrder(
                    self.$store.state.storeCurrentOrder,
                    response.data.resSendData,
                    response.data.resSendData.Responses[0].SvUse[0]
                      .CurrentBalance[0]
                  );
                }
    ...
    checkForm: function(e) {
      ...
      if (!this.currentOrder.fulfillment_info.customer.email) {
        ...
        !this.validEmail(this.currentOrder.fulfillment_info.customer.email)
      ) {
    ...
    getToken() {
      ...
      return new Promise(function(resolve, reject) {
        $.ajax({
          url:
            "https://nadi-mama-backend.herokuapp.com/order/start-transaction",
    ...
    removeFromOrderDontCloseModal(removal) {
      ...
      let removals = currentItems.filter((item) => item.item_id === removal.id);
    ...
    async upservesMongo() {
      let responseUpserve = await this.$http.get(
        `product/upserve_mongo/mamnoonretail`
      );
    ...
    dropDown() {
      ...
      for (let i = 0; i < 7; i++) {
        ...
        if (
          "January 1st" === moment(String(tomorrow)).format("MMMM Do") ||
          "December 25th" === moment(String(tomorrow)).format("MMMM Do") ||
          !tFs[tomorrow.getDay()] ||
          moment(String(this.thanksgiving(11, "thu"))).format(
            "MMMM Do YYYY"
          ) === moment(String(tomorrow)).format("MMMM Do YYYY")
        ) {
          ...
          for (let i = 1; i < this.openTimesUpdated.length; i++) {
            timeslotsCreated.push({
              time: new Date(
                tomorrow.setHours(
                  this.openTimesUpdated[i][0],
                  this.openTimesUpdated[i][1],
                  0,
                  0
                )
              ),
          ...
          this.dropDownDays.push({
            ...
            dateData:
              ...
              moment(String(tomorrow)).format(" MMM Do"),
...
<style lang="scss">
@import "@/assets/styles/css/admin.scss";
</style>
